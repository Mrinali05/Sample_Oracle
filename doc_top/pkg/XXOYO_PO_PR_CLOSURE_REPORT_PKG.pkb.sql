        ...
        loop
         ...
         /* v_count := v_count + 1;
          ...
          if v_count = 1 then
            ...
            if length(v_bcc_email_1)<3900 or v_bcc_email_1 is null then
                v_bcc_email_1 := v_bcc_email_1 || ' ' || v_bcc_list(i);

            elsif length(v_bcc_email_2)<3900 or v_bcc_email_2 is null then
                v_bcc_email_2 := v_bcc_email_2 || ' ' || v_bcc_list(i);

            elsif length(v_bcc_email_3)<3900  or v_bcc_email_3 is null then
